...
#define CONS_QUEUE_SIZE       1024                 // MAXIMUM CONSOLE QUEUE SIZE (ELEMENTS IN THE Q)
#define CONS_MESSAGE_SIZE     1024                 // MAXIMUM CONSOLE MESSAGE LENGTH (EACH ELEMENT IS LONG AT MOST)
